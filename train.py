...
if __name__ == '__main__':
    ...
    if args.phase == 1:
        # train, First phase only use the base classes
        shots = 200
        ...
        # finetune, Second phase only use fewshot number of base and novel classes
        shots = args.shots
    ...
    if args.meta_train:
        # resize images, construct the input dataset of PRN network
        img_size = 768
        ...
        if args.dataset == "coco":
            ...
            # finetune, meta class=base class+nove lclass shot*3
            # train, metaclass=baseclass
            metadataset = MetaDatasetCustom('data/custom', 'trainval.csv', img_size, 'train',
                                            shots=shots, shuffle=True, phase=args.phase)
            metaclass = metadataset.metaclass
    ...
    if args.net == 'metarcnn':
        # num_layers = 101 if args.dataset == 'pascal_voc_0712' or args.dataset == 'custom' else 50
